...
export const WalletSelectButton = (props: { setIsConnected: (isConnected: boolean) => void }) => {
...
const WalletButton = (props: { walletName: string, walletAddress: string, onClick: () => void }) => {
...
const WalletModal = (props: { onClose: () => void, onConnected: (walletName: string) => void, onDisconnected: () => void }) => {
